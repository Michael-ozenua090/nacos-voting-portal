...
// Hardcoded credentials for mock — replace with Supabase Auth in production
const MOCK_EMAIL = "admin@nacos.org.ng";
const MOCK_PASSWORD = "nacos2024admin";
...
export default function AdminLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (email === MOCK_EMAIL && password === MOCK_PASSWORD) {
      // Set session cookie — in production, this would be set by a server-side API route
      // that calls Supabase Auth and returns an HttpOnly cookie
      document.cookie = `${SESSION_COOKIE}=mock-session-token; path=/; max-age=86400; SameSite=Strict`;
